...
export default function DashboardLayout({ 
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Sidebar */}
      <div
        className={`fixed inset-y-0 left-0 z-30 w-64 bg-white shadow-sm transform transition-transform duration-300 ease-in-out lg:translate-x-0 ${
      ...
      >
        <div className="flex flex-col h-full">
          ...
          {/* User info */}
          <div className="px-4 py-4 mx-4 mb-6 rounded-lg bg-gray-50">
        ...
        <header className="bg-white shadow-sm border-b border-gray-200 sticky top-0 z-10">
          <div className="flex items-center justify-between h-16 px-4 lg:px-6">
            ...
            <div className="flex items-center gap-2">
              ...
              {/* User menu */}
              <div className="hidden lg:flex items-center gap-2 ml-2 px-3 py-2 rounded-lg hover:bg-gray-100 cursor-pointer transition-colors">
