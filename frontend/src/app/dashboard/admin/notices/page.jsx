...
export default function NoticesPage() {
  ...
  const notices = [
    { 
      ...
      content: "We will be performing scheduled maintenance on December 5th, 2024 from 2:00 AM to 4:00 AM EST.",
      type: "maintenance",
      status: "active",
      audience: "all",
    ...
    { 
      ...
      content: "We've added a new feature that allows you to upload multiple orders at once using CSV files.",
      type: "feature",
      status: "active",
