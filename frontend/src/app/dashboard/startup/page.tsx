...
export default function StartupOwnerDashboard() {
  ...
  useEffect(() => {
    if (!loading && !user) {
      router.push('/login');
    } else if (!loading && user && user.role !== UserRole.STARTUP_OWNER) {
      router.push('/');
    } else if (user) {
      fetchData();
    }
  ...
  return (
    <DashboardLayout role={UserRole.STARTUP_OWNER}>
      <div className="space-y-8">
        ...
        <div className="grid md:grid-cols-4 gap-6">
          ...
          <div className="bg-orange-50 p-6 rounded-lg">
            <h3 className="text-lg font-semibold text-orange-900 mb-2">Clients</h3>
