...
// SVG Icons as components for Client Dashboard
const DashboardIcon = () => (
...
export const navigationItems = [
  ...
  },
  {
    ...
    icon: <HomeIcon />,
    roles: ["production_owner", "production_manager", "production_staff", "machine_operator", "quality_inspector"],
  },
  {
  ...
  },
  {
    ...
    icon: <MyOrdersIcon />,
    roles: ["production_owner", "production_manager", "production_staff"],
  },
  {
    name: "Billing",
    href: "/dashboard/production/billing",
    icon: <BillingIcon />,
    roles: ["production_owner", "production_manager"],
  },
  {
